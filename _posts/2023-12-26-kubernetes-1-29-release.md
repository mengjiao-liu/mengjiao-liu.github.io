...
read_time: true
show_date: true
title: "Kubernetes 1.29 特性分享"
date: 2023-12-13
img: posts/20231213/kubernetes-1.29.png
tags: [kubernetes]
author: Mengjiao Liu
description: "Kubernetes 1.29 特性分享"
---

大家好，我是 Mengjiao Liu（Github ID: [mengjiao-liu](https://github.com/mengjiao-liu)），是此次 Kubernetes v1.29 发布团队成员。
...
有关如何启用和运行外部云控制器管理器的更多信息，请阅读 [云控制器管理器管理](htttps://kubernetes.io/zh-cn/docs/tasks/administer-cluster/running-cloud-controller/)。
...
![logo](assets/img/posts/20231213/kubernetes-1.29.png)
...
这篇博客首发位于 https://mp.weixin.qq.com/s/ZZJBRWauVo-VwNFHkNQ_2w 。